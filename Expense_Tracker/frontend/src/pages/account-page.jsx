      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center gap-4'>
          <button
            ...
            className='py-1.5 px-2 rounded bg-black dark:bg-violet-600 text-white flex items-center justify-center gap-2 border border-gray-500'
          >
            <MdAdd size={22}/>
